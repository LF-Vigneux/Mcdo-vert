...
\section*{4.}
Avec les éléments des précédentes questions, il est simple de choisir les bases de mesure sur les différents qubits. On souhaite obtenir Hadamard sur l'état du qubit 3 dans le qubit 0. Même chose, on veut Hadamard sur l'état du qubit 11 dans le qubit 8. On a ensuite une Cz entre 0 et 4 et une autre Cz entre 8 et 4. Il suffit donc d'obtenir l'état du qubit 7 dans le qubit 4 en appliquant l'identité. 
\\\\
